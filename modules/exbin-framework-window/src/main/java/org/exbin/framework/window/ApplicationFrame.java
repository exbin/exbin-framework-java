...
public class ApplicationFrame extends javax.swing.JFrame implements ApplicationFrameHandler, WindowHeaderPanel.WindowHeaderDecorationProvider {
    ...
    public void loadMainMenu() {
        ...
        actionModule.buildMenu(menuBar, WindowModule.MAIN_MENU_ID);
    }

    @Override
    public void loadMainToolBar() {
        ActionModuleApi actionModule = App.getModule(ActionModuleApi.class);
        actionModule.buildToolBar(toolBar, WindowModule.MAIN_TOOL_BAR_ID);
    }
    ...
    public void setDefaultSize(Dimension windowSize) {
        ...
        String rectangleString = preferencesModule.getAppPreferences().get(WindowModuleApi.PREFERENCES_FRAME_RECTANGLE, "");
