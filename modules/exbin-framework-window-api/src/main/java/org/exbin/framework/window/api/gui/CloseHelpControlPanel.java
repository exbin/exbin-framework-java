...
public class CloseHelpControlPanel extends javax.swing.JPanel implements CloseControlHandler.CloseControlService, HelpLinkable {
    ...
    public CloseHelpControlPanel() {
        this(App.getModule(LanguageModuleApi.class).getBundle(CloseHelpControlPanel.class));
    }

    public CloseHelpControlPanel(java.util.ResourceBundle resourceBundle) {
