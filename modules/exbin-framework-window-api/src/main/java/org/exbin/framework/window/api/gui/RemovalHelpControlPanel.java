...
public class RemovalHelpControlPanel extends javax.swing.JPanel implements RemovalControlHandler.RemovalControlService, HelpLinkable {
    ...
    public RemovalHelpControlPanel() {
        this(App.getModule(LanguageModuleApi.class).getBundle(RemovalHelpControlPanel.class));
    }

    public RemovalHelpControlPanel(java.util.ResourceBundle resourceBundle) {
