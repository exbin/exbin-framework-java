...
public class TextAppearanceOptions {
    ...
    public void loadFromParameters(TextAppearanceParameters parameters) {
        wordWrapping = parameters.isWordWrapping();
    }

    public void saveToParameters(TextAppearanceParameters parameters) {
        parameters.setWordWrapping(wordWrapping);
    }
