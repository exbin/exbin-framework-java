 ...
 */
package org.exbin.framework.undo;

import org.exbin.framework.undo.action.BasicUndoActions;
...
import org.exbin.framework.undo.gui.UndoManagerControlPanel;
import org.exbin.framework.undo.gui.UndoManagerPanel;
import org.exbin.framework.undo.gui.UndoManagerModel;
 ...
 */
public class UndoModule implements UndoModuleApi {
    ...
    public void actionEditUndo() {
        try {
            ...
            Logger.getLogger(UndoModule.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void registerMainMenu() {
        ...
        actionModule.registerMenuItem(FrameModuleApi.EDIT_MENU_ID, UndoModuleApi.MODULE_ID, defaultUndoActions.getUndoAction(), new MenuPosition(UNDO_MENU_GROUP_ID));
        actionModule.registerMenuItem(FrameModuleApi.EDIT_MENU_ID, UndoModuleApi.MODULE_ID, defaultUndoActions.getRedoAction(), new MenuPosition(UNDO_MENU_GROUP_ID));
    }
    ...
    public void registerUndoManagerInMainMenu() {
        getDefaultUndoActions();
        ActionModuleApi actionModule = application.getModuleRepository().getModuleByInterface(ActionModuleApi.class);
        actionModule.registerMenuItem(FrameModuleApi.EDIT_MENU_ID, UndoModuleApi.MODULE_ID, defaultUndoActions.getUndoManagerAction(), new MenuPosition(UNDO_MENU_GROUP_ID));
    }
    ...
    public void openUndoManager() {
        FrameModuleApi frameModule = UndoModule.this.application.getModuleRepository().getModuleByInterface(FrameModuleApi.class);
