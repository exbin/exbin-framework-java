 ...
 */
package org.exbin.framework.module.update.service.impl;
...
import org.exbin.framework.module.update.ModuleUpdateModule;
...
import org.exbin.framework.module.update.service.CheckForUpdateService.BackgroundCheckListener;
import org.exbin.framework.module.update.service.CheckForUpdateService.CheckForUpdateResult;
...
public class CheckForUpdateServiceImpl implements CheckForUpdateService {
    ...
    private final ModuleUpdateModule guiUpdateModule;

    private Thread checkingThread = null;

    public CheckForUpdateServiceImpl(ModuleUpdateModule guiUpdateModule) {
