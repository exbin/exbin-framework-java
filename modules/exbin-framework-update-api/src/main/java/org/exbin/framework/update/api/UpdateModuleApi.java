...
public interface UpdateModuleApi extends XBApplicationModule {

    public static String MODULE_ID = XBModuleRepositoryUtils.getModuleIdByApi(UpdateModuleApi.class);
