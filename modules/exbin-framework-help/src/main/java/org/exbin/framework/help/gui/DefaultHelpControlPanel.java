...
public class DefaultHelpControlPanel extends javax.swing.JPanel implements DefaultControlHandler.DefaultControlService, HelpLinkable {
    ...
    public DefaultHelpControlPanel() {
        this(App.getModule(LanguageModuleApi.class).getBundle(DefaultHelpControlPanel.class));
    }

    public DefaultHelpControlPanel(java.util.ResourceBundle resourceBundle) {
