...
public class ContributionManager {
                ...
                if (!processingRecord.contributions.isEmpty()) {
                    ...
                    if (contributionMatch.hasFoundMatch()) {
                        ...
                        if (record instanceof BuilderGroupRecord) {
                            ...
                            targetSequence.initItem(((BuilderItemContributionRecord) record).contribution);
    ...
    public void registerDefinition(String definitionId, String pluginId) {
        ...
        ContributionDefinition contributionDefinition = new ContributionDefinition(pluginId);
