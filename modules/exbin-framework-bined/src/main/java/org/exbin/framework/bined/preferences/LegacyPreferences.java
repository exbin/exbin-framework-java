...
public class LegacyPreferences {
    ...
    public boolean isUseDefaultFont() {
        return Boolean.valueOf(preferences.get(TextFontParameters.PREFERENCES_TEXT_FONT_DEFAULT, Boolean.toString(true)));
    }

    public void setUseDefaultFont(boolean useDefaultFont) {
        preferences.put(TextFontParameters.PREFERENCES_TEXT_FONT_DEFAULT, Boolean.toString(useDefaultFont));
    }
