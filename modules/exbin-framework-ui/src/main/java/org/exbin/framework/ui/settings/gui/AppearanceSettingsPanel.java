...
public class AppearanceSettingsPanel extends javax.swing.JPanel implements SettingsComponent<AppearanceSettings>, ComponentResourceProvider {
    ...
    @Override
    public void loadFromOptions(AppearanceSettings options) {
    ...
    @Override
    public void saveToOptions(AppearanceSettings options) {
