...
public class WaveColorDialog extends javax.swing.JDialog {
    ...
    public WaveColorDialog(Frame parent, boolean modal, WaveColorPanelApi colorPanelApi) {
        super(parent, modal);
        this.colorPanelApi = colorPanelApi;
        initComponents();
        waveColorPanel = new WaveColorPanel(colorPanelApi);
    ...
    public void showDialog() {
        waveColorPanel.setWaveColorsFromArray(colorPanelApi.getCurrentWaveColors());
        setVisible(true);
        if (getDialogOption() == JOptionPane.OK_OPTION) {
            colorPanelApi.setCurrentWaveColors(waveColorPanel.getWaveColorsAsArray());
        }
    }
}
